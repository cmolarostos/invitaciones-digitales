...
<div class="invitation-card p-8 text-center relative">
    ...
    <div class="content">
        ...
        <div class="fade-up delay-6" style="margin-bottom:1.5rem; text-align:center;">
            ...
            <div style="margin-top:14px;padding-top:14px;border-top:1px solid rgba(214,140,122,0.4);">
                <p style="font-size:0.8rem;color:var(--sage);margin-bottom:10px;">Confirma tu asistencia al siguiente WhatsApp</p>
