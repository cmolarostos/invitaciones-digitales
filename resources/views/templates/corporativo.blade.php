    ...
    <div class="card p-5 fade-up delay-6" style="text-align:center;margin-bottom:1rem;">
        ...
        <div style="margin-top:14px;padding-top:14px;border-top:1px solid #e5e7eb;">
            ...
            <a href="https://wa.me/{{ $event->rsvp_whatsapp }}?text={{ rawurlencode('¡Hola! Quiero confirmar mi asistencia a '.$event->name) }}"
               ...
               style="display:inline-flex;align-items:center;gap:8px;padding:10px 22px;background:#25D366;color:#fff;border-radius:8px;font-size:0.85rem;font-weight:600;text-decoration:none;font-family:inherit;">
