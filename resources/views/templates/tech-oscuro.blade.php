...
<div class="relative z-10 max-w-lg mx-auto px-4 py-12 space-y-6">
    ...
    <div class="fade-up delay-6 card card-glow p-5" style="text-align:center;margin-bottom:1.5rem;">
        ...
        <div style="margin-top:14px;padding-top:14px;border-top:1px solid rgba(34,211,238,0.3);">
            <p class="section-title" style="font-size:0.75rem;margin-bottom:10px;">CONFIRMA TU ASISTENCIA AL SIGUIENTE WHATSAPP</p>
            <a href="https://wa.me/{{ $event->rsvp_whatsapp }}?text={{ rawurlencode('¡Hola! Quiero confirmar mi asistencia a '.$event->name) }}"
               target="_blank" rel="noopener"
               style="display:inline-flex;align-items:center;gap:8px;padding:10px 22px;background:#25D366;color:#0f172a;border-radius:6px;font-size:0.85rem;font-weight:700;text-decoration:none;font-family:inherit;letter-spacing:0.05em;">
